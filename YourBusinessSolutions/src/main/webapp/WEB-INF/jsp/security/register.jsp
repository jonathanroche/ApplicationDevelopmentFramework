...
Ext.onReady(function() 
{
	...
	var companyDetailsForm = Ext.create('Ext.form.Panel',
	{
	    ...
	    defaults: { anchor: '100%' }, url : '<c:url value="/security/register" />', 
	    items : 
	    [
				...
				[ 
				    {   columnWidth:.5, border:false, layout: 'anchor', defaultType: 'textfield',
						...
						[
							...
							{ fieldLabel: 'Password', name : 'password', anchor:'95%', readOnly : true }
						]
					},
					{   columnWidth:.5, border:false, layout: 'anchor', defaultType: 'textfield',
						items: 
						[
							{ fieldLabel: 'Company Name', name : 'firstName', anchor:'95%', allowBlank : false },
