package org.jroche.app.fwk.dev.service.security;
...
public class CustomUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username)
		...
		org.jroche.app.fwk.dev.persistence.model.user.Company domainUser = userRepository
				.findByCompanyName(username);
		...
		User signedUser = new User(domainUser.getCompanyName(), domainUser
