...
public class QPurchaseOrder extends EntityPathBase<PurchaseOrder> {
    ...
    public final org.jroche.app.fwk.dev.persistence.model.user.QCustomer user;
    ...
    public QPurchaseOrder(Class<? extends PurchaseOrder> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("customer") ? new org.jroche.app.fwk.dev.persistence.model.user.QCustomer(forProperty("customer"), inits.get("customer")) : null;
    }
